...
<head>
	...
	<title>Home</title>	
    <link rel="shortcut icon" type="image/x-icon" href="{{ url('resources/images/favicon.ico') }}">
    <link href="https://fonts.googleapis.com/css?family=Lato:300,400,400italic,700,700italic,900,900italic&amp;subset=latin,latin-ext" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Open%20Sans:300,400,400italic,600,600italic,700,700italic&amp;subset=latin,latin-ext" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{ url('resources/css/animate.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('resources/css/font-awesome.min.css') }}">
    <link rel="stylesheet" type="text css" href="{{ url('resources/css/bootstrap.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('resources/css/owl.carousel.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('resources/css/color-01.css') }}">
...
<body class="home-page home-01 ">
    ...
    <script src="{{ url('resources/js/jquery-1.12.4.minb8ff.js?ver=1.12.4') }}"></script>
    <script src="{{ url('resources/js/jquery-ui-1.12.4.minb8ff.js?ver=1.12.4') }}"></script>
    <script src="{{ url('resources/js/bootstrap.min.js') }}"></script>
    <script src="{{ url('resources/js/jquery.flexslider.js') }}"></script>
    <script src="{{ url('resources/js/chosen.jquery.min.js') }}"></script>
    <script src="{{ url('resources/js/owl.carousel.min.js') }}"></script>
    <script src="{{ url('resources/js/jquery.countdown.min.js') }}"></script>
